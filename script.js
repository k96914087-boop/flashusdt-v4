...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const NETWORK_DETAILS = {
        tron: { key: "tron", name: "Tron (TRC20)", ticker: "TRX", address: TRON_DEPOSIT_ADDRESS, rate: TRX_PER_USD, qrPrefix: "tron:", minFee: 0.5, cryptoPrecision: 6, iconUrl: "https://cdn.iconscout.com/icon/premium/png-512-thumb/tron-trx-7152138-5795294.png?f=webp&w=256" },
        ethereum: { key: "ethereum", name: "Ethereum (ERC20)", ticker: "ETH", address: ETHEREUM_DEPOSIT_ADDRESS, rate: ETH_PER_USD, qrPrefix: "ethereum:", minFee: 5.0, cryptoPrecision: 8, iconUrl: "https://cdn.iconscout.com/icon/free/png-512/free-ethereum-1-283135.png?f=webp&w=256" }
    };
